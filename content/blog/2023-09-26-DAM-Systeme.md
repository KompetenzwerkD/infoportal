...
* Islandora https://www.islandora.ca/(https://www.islandora.ca/) und
* DSpace https://dspace.lyrasis.org/(https://dspace.lyrasis.org/).

Die vorgestellten Systeme haben dabei eine Vielzahl an Gemeinsamkeiten.

Beide sind oder besitzen im Kern eine [Repositorien-Software](@/glossar/_index.md#repositorium). DSpace ist an sich selbst ein Repositorium, Islandora ist um die Fedora Commons (https://fedora.lyrasis.org/(https://fedora.lyrasis.org/)) Repositorien-Software herum gebaut. Die vorgestellten Lösungen eignen sich somit beide für den generellen Einsatz rund um die Speicherung, [Kuration](@/glossar/_index.md#datenkuration) und [Archivierung](@/glossar/_index.md#archivierung) digitaler Objekte auch dank ihrer OAIS (Open Archival Information System)-Konformität, der Integration typischer PID-Standards, der Unterstützung von Versionierung und dem Vorhandensein von Schnittstellen wie OAI-PMH für Metadaten sowie generellem REST-basierten Zugriff auf die gesamte Datenbasis.
...
Beide Lösungen sind unter [Open Source](@/glossar/_index.md#open-source)\-Lizenzen (DSpace: BSD-Lizenz, Islandora: GNU GPL v2.0) verfügbar. Der Quellcode ist dabei jeweils auf [github](@/glossar/_index.md#github) zu finden ([DSpace](https://github.com/Dspace/DSpace/(https://github.com/Dspace/DSpace/), [Islandora](https://github.com/Islandora/islandora\(https://github.com/Islandora/islandora\)).
...
* [DSpace-Dokumentation](https://wiki.lyrasis.org/display/DSDOC7x)
...
* [Open Source-Lösungen](@/glossar/_index.md#open-source)
...
Sollte Bedarf oder Interesse an einem Workshop zu Islandora und/oder DSpace bestehen, so teilen sie uns dies bitte mit. Gerne können wir das bei unseren zukünftigen Planungen berücksichtigen.
