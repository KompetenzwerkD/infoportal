...
###### Linked Open Data
Forschungsdaten, die im Internet frei zugänglich (“Open”, sonst nur “Linked Data”) und mit speziellen persistenten Identifikatoren - sogenannten Uniform Resource Identifiern (URI) - versehen sind und daurch maschinenlesbar verlinkt werden können. Durch Verknüpfung der Daten ergibt sich so ein umfangreiches Wissensnetzwerk, das auch als "Linked Open Data Cloud" bezeichnet wird. 
...
###### Metadaten
Beschreibende Daten zu z. B. Forschungsdaten. Metadaten sind strukturiert und geben Hinweise zu Eigenschaften der Daten, die sie näher bestimmen. Dazu gehörenn Name, ISBN, Sachgebiet, Autor etc.
...
[Open Access Infrastructure for Research in Europe] Europäisches Forschungsinformationssystem für Metadaten, wozu u. a. Zenodo gehört.
...
[Rat für Informationsinfrastrukturen] Gremium, welchesPolitik und Wissenschaft im Bereich von Digitalstrategien berät.
...
###### Schema
Festgelegte Ordnung, Plan oder Konzept von einem Sachverhalt, nach der man sich richtet. Eine Rolle spielen Schemata beispielsweise im Bereich der Metadaten. Ein Metadatenschema gibt den Inhalt und die Gliederung von Metadaten vor.
...
###### Standard
Einheitliche und weithin anerkannte Art und Weise etwas zu tun. Siehe beispielsweise Metadaten und Ontologie.
...
Freie Erweiterung zu MediaWiki, welche mithilfe derer  maschinenlesbare, strukturierte Wissensdatenbanken erstellt werden können.  Es verwendet dabei LOD Prinzipien und die Daten können mittels SPARQL  abgefragt werden bzw. u.a. als RDF/XML, N3, Json, Yaml etc. exportiert  werden.

###### [Wikidata](https://www.wikidata.org/)
Eine gescheinschaftlich kuratierte offene Wissensbasis, welche von der Wikimedia Foundation betrieben wird. Darin werden Informationen strukturiert erfasst und maschinenlesbar zur Verfügung gestellt. Die Daten werden auch in anderen Wikimedia-Projekten wie z.B. Wikipedia eingebunden. Technisch basiert Wikidata auf MediaWiki mit der Wikibase-Erweiterung.
